                ...
                <div className="footer-content">
                    <div className="footer-item">
                        ...
                        <div className="footer-item__links">
                            <a href="#">
                                <img src={FacebookImg} alt="Facebook" width='50' />
                            </a>
                            <a href="#">
                                <img src={InstagramImg} alt="Instagram" width='50' />
                            </a>
                            <a href="#">
                                <img src={YoutubeImg} alt="YouTube" width='50' />
                            </a>
                            <a href="#">
                                <img src={TelegramImg} alt="Telegram" width='50' />
                            </a>
                        </div>
